...
def get_security_from_env(security: Any, security_class: Any) -> Optional[BaseModel]:
    ...
    if os.getenv("NINJAPY_OAUTH2"):
        security_dict["oauth2"] = os.getenv("NINJAPY_OAUTH2")

    if os.getenv("NINJAPY_SESSION_KEY"):
        security_dict["session_key"] = os.getenv("NINJAPY_SESSION_KEY")
