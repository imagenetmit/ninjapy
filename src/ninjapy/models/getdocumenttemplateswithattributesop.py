...
class GetDocumentTemplatesWithAttributesRequestTypedDict(TypedDict):
    template_name: NotRequired[str]
    include_technician_roles: NotRequired[bool]
    r"""Includes allowed technician roles."""


class GetDocumentTemplatesWithAttributesRequest(BaseModel):
    template_name: Annotated[
        Optional[str],
        pydantic.Field(alias="templateName"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None

    include_technician_roles: Annotated[
        Optional[bool],
        pydantic.Field(alias="includeTechnicianRoles"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = False
    r"""Includes allowed technician roles."""


class GetDocumentTemplatesWithAttributesFieldType(str, Enum):
    r"""Field type"""
...
class GetDocumentTemplatesWithAttributesFieldTechnicianPermission(str, Enum):
...
class GetDocumentTemplatesWithAttributesFieldScriptPermission(str, Enum):
...
class GetDocumentTemplatesWithAttributesFieldAPIPermission(str, Enum):
...
class GetDocumentTemplatesWithAttributesValuesTypedDict(TypedDict):
...
class GetDocumentTemplatesWithAttributesValues(BaseModel):
    r"""Used for dropdown options"""
...
class GetDocumentTemplatesWithAttributesType(str, Enum):
    NONE = "NONE"
    INCLUDE = "INCLUDE"
    EXCLUDE = "EXCLUDE"
...
class GetDocumentTemplatesWithAttributesDateFiltersTypedDict(TypedDict):
    type: NotRequired[GetDocumentTemplatesWithAttributesType]
    selected: NotRequired[List[str]]


class GetDocumentTemplatesWithAttributesDateFilters(BaseModel):
    type: Optional[GetDocumentTemplatesWithAttributesType] = None

    selected: Optional[List[str]] = None


class GetDocumentTemplatesWithAttributesComplexityRulesTypedDict(TypedDict):
...
class GetDocumentTemplatesWithAttributesComplexityRules(BaseModel):
...
class GetDocumentTemplatesWithAttributesNumericRangeTypedDict(TypedDict):
    min: NotRequired[float]
    max: NotRequired[float]


class GetDocumentTemplatesWithAttributesNumericRange(BaseModel):
    min: Optional[float] = None

    max: Optional[float] = None


class GetDocumentTemplatesWithAttributesNodeClass(str, Enum):
...
class GetDocumentTemplatesWithAttributesIPAddressType(str, Enum):
    ALL = "ALL"
    IPV4 = "IPV4"
    IPV6 = "IPV6"


class GetDocumentTemplatesWithAttributesAdvancedSettingsTypedDict(TypedDict):
    file_max_size: NotRequired[int]
    file_extensions: NotRequired[List[str]]
    date_filters: NotRequired[GetDocumentTemplatesWithAttributesDateFiltersTypedDict]
    max_characters: NotRequired[int]
    complexity_rules: NotRequired[
        GetDocumentTemplatesWithAttributesComplexityRulesTypedDict
    ]
    numeric_range: NotRequired[GetDocumentTemplatesWithAttributesNumericRangeTypedDict]
    org: NotRequired[List[int]]
    node_class: NotRequired[List[GetDocumentTemplatesWithAttributesNodeClass]]
    ip_address_type: NotRequired[GetDocumentTemplatesWithAttributesIPAddressType]
    expand_large_value_on_render: NotRequired[bool]


class GetDocumentTemplatesWithAttributesAdvancedSettings(BaseModel):
    ...
    date_filters: Annotated[
        Optional[GetDocumentTemplatesWithAttributesDateFilters],
    ...
    complexity_rules: Annotated[
        Optional[GetDocumentTemplatesWithAttributesComplexityRules],
        pydantic.Field(alias="complexityRules"),
    ] = None

    numeric_range: Annotated[
        Optional[GetDocumentTemplatesWithAttributesNumericRange],
    ...
    node_class: Annotated[
        Optional[List[GetDocumentTemplatesWithAttributesNodeClass]],
        pydantic.Field(alias="nodeClass"),
    ] = None

    ip_address_type: Annotated[
        Optional[GetDocumentTemplatesWithAttributesIPAddressType],
...
class GetDocumentTemplatesWithAttributesFieldContentTypedDict(TypedDict):
    r"""Field content"""

    values: NotRequired[List[GetDocumentTemplatesWithAttributesValuesTypedDict]]
    r"""Used for dropdown options"""
...
class GetDocumentTemplatesWithAttributesFieldContent(BaseModel):
    r"""Field content"""

    values: Optional[List[GetDocumentTemplatesWithAttributesValues]] = None
    r"""Used for dropdown options"""
    ...
    advanced_settings: Annotated[
        Optional[GetDocumentTemplatesWithAttributesAdvancedSettings],
        pydantic.Field(alias="advancedSettings"),
    ] = None


class GetDocumentTemplatesWithAttributesUIElementType(str, Enum):
    r"""UI element type"""
...
class GetDocumentTemplatesWithAttributesFieldsTypedDict(TypedDict):
    ...
    r"""Field description"""
    field_type: NotRequired[GetDocumentTemplatesWithAttributesFieldType]
    r"""Field type"""
    ...
    r"""Default value"""
    field_content: NotRequired[GetDocumentTemplatesWithAttributesFieldContentTypedDict]
    r"""Field content"""
    ui_element_uid: NotRequired[str]
    r"""UI element identifier"""
    ui_element_name: NotRequired[str]
    r"""UI element name"""
    ui_element_type: NotRequired[GetDocumentTemplatesWithAttributesUIElementType]
    r"""UI element type"""
...
class GetDocumentTemplatesWithAttributesFields(BaseModel):
    r"""Document template fields"""
    ...
    field_type: Annotated[
        Optional[GetDocumentTemplatesWithAttributesFieldType],
        pydantic.Field(alias="fieldType"),
    ] = None
    r"""Field type"""

    field_technician_permission: Annotated[
        Optional[GetDocumentTemplatesWithAttributesFieldTechnicianPermission],
        pydantic.Field(alias="fieldTechnicianPermission"),
    ] = None
    r"""Field technician permission"""

    field_script_permission: Annotated[
        Optional[GetDocumentTemplatesWithAttributesFieldScriptPermission],
        pydantic.Field(alias="fieldScriptPermission"),
    ] = None
    r"""Field script permission"""

    field_api_permission: Annotated[
        Optional[GetDocumentTemplatesWithAttributesFieldAPIPermission],
    ...
    field_content: Annotated[
        Optional[GetDocumentTemplatesWithAttributesFieldContent],
    ...
    ui_element_type: Annotated[
        Optional[GetDocumentTemplatesWithAttributesUIElementType],
...
class GetDocumentTemplatesWithAttributesArchivedByTypedDict(TypedDict):
...
class GetDocumentTemplatesWithAttributesArchivedBy(BaseModel):
    r"""Indicates who archived the template"""
...
class GetDocumentTemplatesWithAttributesResponseBodyTypedDict(TypedDict):
    id: NotRequired[int]
    r"""Identifier"""
    name: NotRequired[str]
    ...
    r"""Last updated time"""
    fields: NotRequired[List[GetDocumentTemplatesWithAttributesFieldsTypedDict]]
    r"""Document template fields"""
    ...
    archived_by: NotRequired[GetDocumentTemplatesWithAttributesArchivedByTypedDict]
    r"""Indicates who archived the template"""


class GetDocumentTemplatesWithAttributesResponseBody(BaseModel):
    id: Optional[int] = None
    r"""Identifier"""
    ...
    fields: Optional[List[GetDocumentTemplatesWithAttributesFields]] = None
    r"""Document template fields"""
    ...
    archived_by: Annotated[
        Optional[GetDocumentTemplatesWithAttributesArchivedBy],
