...
class GetOrganizationLocationUsageRequestTypedDict(TypedDict):
    id: str
    r"""Organization identifier"""


class GetOrganizationLocationUsageRequest(BaseModel):
    id: Annotated[
...
class GetOrganizationLocationUsageResponseBodyTypedDict(TypedDict):
...
class GetOrganizationLocationUsageResponseBody(BaseModel):
