...
class GetDocumentTemplateFieldType(str, Enum):
    r"""Field type"""
...
class GetDocumentTemplateFieldTechnicianPermission(str, Enum):
...
class GetDocumentTemplateFieldScriptPermission(str, Enum):
...
class GetDocumentTemplateFieldAPIPermission(str, Enum):
...
class GetDocumentTemplateValuesTypedDict(TypedDict):
...
class GetDocumentTemplateValues(BaseModel):
    r"""Used for dropdown options"""
...
class GetDocumentTemplateType(str, Enum):
    NONE = "NONE"
    INCLUDE = "INCLUDE"
    EXCLUDE = "EXCLUDE"
...
class GetDocumentTemplateDateFiltersTypedDict(TypedDict):
    type: NotRequired[GetDocumentTemplateType]
    selected: NotRequired[List[str]]


class GetDocumentTemplateDateFilters(BaseModel):
    type: Optional[GetDocumentTemplateType] = None

    selected: Optional[List[str]] = None


class GetDocumentTemplateComplexityRulesTypedDict(TypedDict):
...
class GetDocumentTemplateComplexityRules(BaseModel):
...
class GetDocumentTemplateNumericRangeTypedDict(TypedDict):
    min: NotRequired[float]
    max: NotRequired[float]


class GetDocumentTemplateNumericRange(BaseModel):
    min: Optional[float] = None

    max: Optional[float] = None


class GetDocumentTemplateNodeClass(str, Enum):
...
class GetDocumentTemplateIPAddressType(str, Enum):
    ALL = "ALL"
    IPV4 = "IPV4"
    IPV6 = "IPV6"


class GetDocumentTemplateAdvancedSettingsTypedDict(TypedDict):
    file_max_size: NotRequired[int]
    file_extensions: NotRequired[List[str]]
    date_filters: NotRequired[GetDocumentTemplateDateFiltersTypedDict]
    max_characters: NotRequired[int]
    complexity_rules: NotRequired[GetDocumentTemplateComplexityRulesTypedDict]
    numeric_range: NotRequired[GetDocumentTemplateNumericRangeTypedDict]
    org: NotRequired[List[int]]
    node_class: NotRequired[List[GetDocumentTemplateNodeClass]]
    ip_address_type: NotRequired[GetDocumentTemplateIPAddressType]
    expand_large_value_on_render: NotRequired[bool]


class GetDocumentTemplateAdvancedSettings(BaseModel):
    ...
    date_filters: Annotated[
        Optional[GetDocumentTemplateDateFilters], pydantic.Field(alias="dateFilters")
    ] = None
    ...
    complexity_rules: Annotated[
        Optional[GetDocumentTemplateComplexityRules],
        pydantic.Field(alias="complexityRules"),
    ] = None

    numeric_range: Annotated[
        Optional[GetDocumentTemplateNumericRange], pydantic.Field(alias="numericRange")
    ] = None

    org: Optional[List[int]] = None

    node_class: Annotated[
        Optional[List[GetDocumentTemplateNodeClass]], pydantic.Field(alias="nodeClass")
    ] = None

    ip_address_type: Annotated[
        Optional[GetDocumentTemplateIPAddressType],
...
class GetDocumentTemplateFieldContentTypedDict(TypedDict):
    r"""Field content"""

    values: NotRequired[List[GetDocumentTemplateValuesTypedDict]]
    r"""Used for dropdown options"""
    ...
    r"""Tooltip text"""
    advanced_settings: NotRequired[GetDocumentTemplateAdvancedSettingsTypedDict]


class GetDocumentTemplateFieldContent(BaseModel):
    r"""Field content"""

    values: Optional[List[GetDocumentTemplateValues]] = None
    r"""Used for dropdown options"""
    ...
    advanced_settings: Annotated[
        Optional[GetDocumentTemplateAdvancedSettings],
        pydantic.Field(alias="advancedSettings"),
    ] = None


class GetDocumentTemplateUIElementType(str, Enum):
    r"""UI element type"""
...
class GetDocumentTemplateFieldsTypedDict(TypedDict):
    ...
    r"""Field description"""
    field_type: NotRequired[GetDocumentTemplateFieldType]
    r"""Field type"""
    field_technician_permission: NotRequired[
        GetDocumentTemplateFieldTechnicianPermission
    ]
    r"""Field technician permission"""
    field_script_permission: NotRequired[GetDocumentTemplateFieldScriptPermission]
    r"""Field script permission"""
    field_api_permission: NotRequired[GetDocumentTemplateFieldAPIPermission]
    r"""Field public API permission"""
    field_default_value: NotRequired[str]
    r"""Default value"""
    field_content: NotRequired[GetDocumentTemplateFieldContentTypedDict]
    r"""Field content"""
    ui_element_uid: NotRequired[str]
    r"""UI element identifier"""
    ui_element_name: NotRequired[str]
    r"""UI element name"""
    ui_element_type: NotRequired[GetDocumentTemplateUIElementType]
    r"""UI element type"""
...
class GetDocumentTemplateFields(BaseModel):
    r"""Document template fields"""
    ...
    field_type: Annotated[
        Optional[GetDocumentTemplateFieldType], pydantic.Field(alias="fieldType")
    ] = None
    r"""Field type"""

    field_technician_permission: Annotated[
        Optional[GetDocumentTemplateFieldTechnicianPermission],
        pydantic.Field(alias="fieldTechnicianPermission"),
    ] = None
    r"""Field technician permission"""

    field_script_permission: Annotated[
        Optional[GetDocumentTemplateFieldScriptPermission],
        pydantic.Field(alias="fieldScriptPermission"),
    ] = None
    r"""Field script permission"""

    field_api_permission: Annotated[
        Optional[GetDocumentTemplateFieldAPIPermission],
    ...
    field_content: Annotated[
        Optional[GetDocumentTemplateFieldContent], pydantic.Field(alias="fieldContent")
    ] = None
    r"""Field content"""
    ...
    ui_element_type: Annotated[
        Optional[GetDocumentTemplateUIElementType],
...
class GetDocumentTemplateArchivedByTypedDict(TypedDict):
...
class GetDocumentTemplateArchivedBy(BaseModel):
    r"""Indicates who archived the template"""
...
class GetDocumentTemplateResponseBodyTypedDict(TypedDict):
    r"""Returns a document template"""
    ...
    r"""Last updated time"""
    fields: NotRequired[List[GetDocumentTemplateFieldsTypedDict]]
    r"""Document template fields"""
    ...
    archived_by: NotRequired[GetDocumentTemplateArchivedByTypedDict]
    r"""Indicates who archived the template"""


class GetDocumentTemplateResponseBody(BaseModel):
    r"""Returns a document template"""
    ...
    fields: Optional[List[GetDocumentTemplateFields]] = None
    r"""Document template fields"""
    ...
    archived_by: Annotated[
        Optional[GetDocumentTemplateArchivedBy], pydantic.Field(alias="archivedBy")
    ] = None
    r"""Indicates who archived the template"""
