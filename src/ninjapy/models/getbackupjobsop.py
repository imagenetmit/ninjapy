...
class GetBackupJobsRequestTypedDict(TypedDict):
    df: NotRequired[str]
    r"""Device filter"""
    ddf: NotRequired[str]
...
class GetBackupJobsRequest(BaseModel):
    df: Annotated[
        Optional[str],
...
class GetBackupJobsCursorTypedDict(TypedDict):
...
class GetBackupJobsCursor(BaseModel):
...
class GetBackupJobsResultsTypedDict(TypedDict):
...
class GetBackupJobsResults(BaseModel):
...
class GetBackupJobsResponseBodyTypedDict(TypedDict):
    r"""Returns a backup job report"""

    cursor: NotRequired[GetBackupJobsCursorTypedDict]
    results: NotRequired[List[GetBackupJobsResultsTypedDict]]


class GetBackupJobsResponseBody(BaseModel):
    r"""Returns a backup job report"""

    cursor: Optional[GetBackupJobsCursor] = None

    results: Optional[List[GetBackupJobsResults]] = None
