...
class GetDeviceActivitiesRequestTypedDict(TypedDict):
    id: int
    r"""Device identifier"""
...
class GetDeviceActivitiesRequest(BaseModel):
    id: Annotated[
    ...
    activity_type: Annotated[
        Optional[str],
        pydantic.Field(alias="activityType"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Return activities of type"""
...
class GetDeviceActivitiesSeverity(str, Enum):
    r"""Severity"""
...
class GetDeviceActivitiesPriority(str, Enum):
    r"""Priority"""
...
class ActivitiesTypedDict(TypedDict):
    ...
    r"""Device identifier"""
    severity: NotRequired[GetDeviceActivitiesSeverity]
    r"""Severity"""
    priority: NotRequired[GetDeviceActivitiesPriority]
    r"""Priority"""
    series_uid: NotRequired[str]
    r"""Activity series UID (job/condition UID)"""
    activity_type: NotRequired[ActivityType]
    r"""Activity type code"""
    status_code: NotRequired[StatusCode]
    r"""Activity status code"""
    status: NotRequired[str]
    r"""Status description"""
    activity_result: NotRequired[ActivityResult]
    r"""Activity result"""
...
class Activities(BaseModel):
    ...
    severity: Optional[GetDeviceActivitiesSeverity] = None
    r"""Severity"""

    priority: Optional[GetDeviceActivitiesPriority] = None
    r"""Priority"""
    ...
    activity_type: Annotated[
        Optional[ActivityType], pydantic.Field(alias="activityType")
    ] = None
    r"""Activity type code"""
    ...
    activity_result: Annotated[
        Optional[ActivityResult], pydantic.Field(alias="activityResult")
    ] = None
    r"""Activity result"""
...
class GetDeviceActivitiesResponseBodyTypedDict(TypedDict):
    r"""default response"""

    last_activity_id: NotRequired[int]
    r"""Last recorded activity ID for account"""
    activities: NotRequired[List[ActivitiesTypedDict]]
    last_node_activity_id: NotRequired[int]
    r"""Last recorded activity ID for device"""


class GetDeviceActivitiesResponseBody(BaseModel):
    r"""default response"""
    ...
    last_node_activity_id: Annotated[
        Optional[int], pydantic.Field(alias="lastNodeActivityId")
    ] = None
    r"""Last recorded activity ID for device"""
