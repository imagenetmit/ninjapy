...
class Class(str, Enum):
    r"""Activity Class (System/Device) filter"""
...
class GetActivitiesRequestTypedDict(TypedDict):
    class_: NotRequired[Class]
    r"""Activity Class (System/Device) filter"""
    before: NotRequired[str]
    r"""Return activities recorded prior to specified date"""
    after: NotRequired[str]
    r"""Return activities recorded after to specified date"""
    older_than: NotRequired[int]
    r"""Return activities recorded that are newer than specified activity ID"""
    newer_than: NotRequired[int]
    r"""Return activities recorded that are older than specified activity ID"""
    type: NotRequired[str]
    r"""Return activities of type"""
    status: NotRequired[str]
    r"""Return activities with status(es)"""
    user: NotRequired[str]
    r"""Return activities for user(s)"""
    series_uid: NotRequired[str]
    r"""Return activities related to alert (series)"""
    df: NotRequired[str]
    r"""Device filter"""
    page_size: NotRequired[int]
    r"""Limit number of activities to return"""
    lang: NotRequired[str]
    r"""Language tag"""
    tz: NotRequired[str]
    r"""Time Zone"""
    source_config_uid: NotRequired[str]
    r"""Allows users to make a request directed to a specific script"""
...
class GetActivitiesRequest(BaseModel):
    ...
    older_than: Annotated[
        Optional[int],
        pydantic.Field(alias="olderThan"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Return activities recorded that are newer than specified activity ID"""
    ...
    newer_than: Annotated[
        Optional[int],
        pydantic.Field(alias="newerThan"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Return activities recorded that are older than specified activity ID"""
    ...
    series_uid: Annotated[
        Optional[str],
        pydantic.Field(alias="seriesUid"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Return activities related to alert (series)"""
    ...
    source_config_uid: Annotated[
        Optional[str],
        pydantic.Field(alias="sourceConfigUid"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Allows users to make a request directed to a specific script"""


class GetActivitiesSeverity(str, Enum):
    r"""Severity"""
...
class GetActivitiesPriority(str, Enum):
    r"""Priority"""
...
class GetActivitiesActivityType(str, Enum):
    r"""Activity type code"""
...
class GetActivitiesStatusCode(str, Enum):
    r"""Activity status code"""
    ...
    NINJA_BACKUP_BACKUP_CONFIGURE_FAILED = "NINJA_BACKUP_BACKUP_CONFIGURE_FAILED"
    ...
    QC_DEVICE_AGENT_INSTALL_REQUESTED = "QC_DEVICE_AGENT_INSTALL_REQUESTED"
    ...
    SENTINEL_ONE_REGISTRATION_FAILED = "SENTINEL_ONE_REGISTRATION_FAILED"
    ...
    CROWDSTRIKE_THREAT_DETECTED = "CROWDSTRIKE_THREAT_DETECTED"
    ...
    KNOWLEDGE_BASE_PUBLIC_LINK_DELETED = "KNOWLEDGE_BASE_PUBLIC_LINK_DELETED"
...
class GetActivitiesActivityResult(str, Enum):
    r"""Activity result"""
...
class GetActivitiesActivitiesTypedDict(TypedDict):
    id: NotRequired[int]
    r"""Activity identifier"""
    activity_time: NotRequired[float]
    r"""Activity timestamp"""
    device_id: NotRequired[int]
    r"""Device identifier"""
    severity: NotRequired[GetActivitiesSeverity]
    r"""Severity"""
    priority: NotRequired[GetActivitiesPriority]
    r"""Priority"""
    series_uid: NotRequired[str]
    r"""Activity series UID (job/condition UID)"""
    activity_type: NotRequired[GetActivitiesActivityType]
    r"""Activity type code"""
    status_code: NotRequired[GetActivitiesStatusCode]
    r"""Activity status code"""
    status: NotRequired[str]
    r"""Status description"""
    activity_result: NotRequired[GetActivitiesActivityResult]
    r"""Activity result"""
    source_config_uid: NotRequired[str]
    ...
    r"""Activity message"""
    type: NotRequired[str]
    r"""Activity type description"""
    data: NotRequired[Dict[str, Any]]
    r"""Activity data"""


class GetActivitiesActivities(BaseModel):
    id: Optional[int] = None
    r"""Activity identifier"""

    activity_time: Annotated[Optional[float], pydantic.Field(alias="activityTime")] = (
        None
    )
    r"""Activity timestamp"""
    ...
    severity: Optional[GetActivitiesSeverity] = None
    r"""Severity"""

    priority: Optional[GetActivitiesPriority] = None
    r"""Priority"""

    series_uid: Annotated[Optional[str], pydantic.Field(alias="seriesUid")] = None
    r"""Activity series UID (job/condition UID)"""

    activity_type: Annotated[
        Optional[GetActivitiesActivityType], pydantic.Field(alias="activityType")
    ] = None
    r"""Activity type code"""

    status_code: Annotated[
        Optional[GetActivitiesStatusCode], pydantic.Field(alias="statusCode")
    ] = None
    r"""Activity status code"""
    ...
    activity_result: Annotated[
        Optional[GetActivitiesActivityResult], pydantic.Field(alias="activityResult")
    ] = None
    r"""Activity result"""
...
class GetActivitiesResponseBodyTypedDict(TypedDict):
    ...
    last_activity_id: NotRequired[int]
    r"""Last recorded activity ID for account"""
    activities: NotRequired[List[GetActivitiesActivitiesTypedDict]]
...
class GetActivitiesResponseBody(BaseModel):
    ...
    last_activity_id: Annotated[
        Optional[int], pydantic.Field(alias="lastActivityId")
    ] = None
    r"""Last recorded activity ID for account"""

    activities: Optional[List[GetActivitiesActivities]] = None
